...
export function KanzhangParityPage({tool}:{tool:ToolManifest}){
  ...
  return <div className="kz-page">
    <PageHeader eyebrow="凭证映射与科目筛选" title={tool.name} detail="按三步流程完成字段映射、科目穿梭、多批次、凭证类型、JE 匹配、损益结转与导出。" />
