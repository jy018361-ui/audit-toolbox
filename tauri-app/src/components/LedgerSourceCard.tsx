 ...
 */
export function LedgerSourceCard({inputPath,sheet,knownSheets,headerRow,dragHover,busy,job,needsReload,onBrowse,onClear,onSheetChange,onHeaderRowChange,onInspect,onCancel,children}:{
  ...
  return <section className="kz-card">
    ...
    <div className="kz-two">
      ...
      <label>标题行<input type="number" min={1} value={headerRow} onChange={e=>onHeaderRowChange(Number(e.target.value)||1)}/></label>
    </div>
