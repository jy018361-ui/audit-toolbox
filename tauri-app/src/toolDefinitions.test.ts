...
describe("tool definitions", () => {
  it("registers every production tool", () => {
    expect(Object.keys(TOOL_DEFINITIONS)).toHaveLength(17);
  });

  it("uses only allow-listed engine method namespaces", () => {
    const allowed = new Set(["file_list", "wp", "confirmation", "excel_merger", "fa", "ts", "kanzhang", "roll_forward", "audipick", "fx", "loan", "deposit", "pdf2excel", "fuzzy"]);
